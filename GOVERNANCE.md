...
### 4. Transparency
We are 100% transparent about the fact that we have no idea why certain DuckDB queries are as fast as they are. We just assume it’s magic and move on.

### 5. Open Source (Sort Of)
You are free to fork this project, but if you change the theme to Light Mode, you are legally required to delete the repository and rethink your life choices.
