...
### 1. Local-First, Cloud-Third
The Cloud is a fallback for when you’ve lost your physical sense of self. Everything starts and ends on the disk.

### 2. Type Safety as an Obsession
...
### 5. Error Messages as Literature
An error message should tell a story. Ideally, a tragic one about a lost database connection or a malformed JSON metadata block. "Internal Server Error" is for people who have given up on life.
