        ...
        <div className="prose prose-invert max-w-none break-words">
            <ReactMarkdown
                ...
                components={{
                    ...
                    h1: ({ children }) => <h1 className="text-2xl font-bold mb-4 text-monokai-aqua">{children}</h1>,
                    h2: ({ children }) => <h2 className="text-xl font-bold mb-3 text-monokai-aqua">{children}</h2>,
                    h3: ({ children }) => <h3 className="text-lg font-bold mb-2 text-monokai-aqua">{children}</h3>,
                    blockquote: ({ children }) => (
